...
export const TutorialVideosSection: React.FC<TutorialVideosSectionProps> = ({
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Toast Notification */}
      {toastMsg && (
        <div className="fixed bottom-6 right-6 z-50 bg-slate-900 border border-blue-500/40 text-blue-300 px-4 py-3 rounded-2xl shadow-2xl text-xs font-bold flex items-center gap-2 animate-in slide-in-from-bottom-5">
