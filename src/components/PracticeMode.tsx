...
export const PracticeMode: React.FC<PracticeModeProps> = ({
  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-4 py-8 space-y-6" id="practice-mode-container">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 sm:p-7 shadow-xs space-y-5">
          ...
          <div className="flex items-center justify-between pb-3 border-b border-slate-200 dark:border-slate-800">
            <button
              ...
              className="px-3.5 py-2 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 rounded-xl text-xs font-bold transition-all flex items-center gap-2 border border-slate-200 dark:border-slate-700 cursor-pointer shadow-xs"
              id="practice-top-back-btn"
          ...
          <div className="flex items-center space-x-3 pb-4 border-b border-slate-200 dark:border-slate-800">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white">Practice Mode & CBT Practice Engine</h1>
              <p className="text-xs text-slate-500 dark:text-slate-400">Configure parameters and practice mode analysis engine.</p>
            </div>
          </div>
          ...
          <div className="p-4 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <button
                ...
                className={`p-3.5 rounded-xl border text-left transition-all cursor-pointer flex items-start gap-3 ${
                  practiceEngineMode === 'interactive'
                    ? 'bg-blue-50/80 dark:bg-blue-950/30 border-[#1e3a8a] dark:border-blue-500 text-slate-900 dark:text-white ring-1 ring-[#1e3a8a]'
              ...
              >
                <div className="p-2 rounded-lg bg-blue-100 dark:bg-blue-500/20 text-[#1e3a8a] dark:text-blue-300 shrink-0">
                  <Sparkles className="w-5 h-5" />
                </div>
                <div>
                  <h3 className="text-xs font-bold text-slate-900 dark:text-white">Interactive Step-by-Step Practice</h3>
              ...
              >
                ...
                <div>
                  <h3 className="text-xs font-bold text-slate-900 dark:text-white">Mock CBT Practice Engine</h3>
                  <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5 leading-relaxed">
        ...
        <div className="space-y-5">
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-4 rounded-xl shadow-xs space-y-3">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div className="flex items-center space-x-3">
                <span className="text-xs font-bold text-[#1e3a8a] dark:text-blue-400 bg-blue-50 dark:bg-blue-500/10 px-2.5 py-1 rounded-lg border border-blue-200 dark:border-blue-500/20">
              ...
              {isTimed ? (
                <div className={`px-3 py-1 rounded-lg border text-xs font-black font-mono flex items-center gap-1.5 ${
                  isTimeLow ? 'bg-rose-500/20 text-rose-300 border-rose-500/50 animate-pulse' : 'bg-slate-950 text-blue-400 border-slate-800'
                }`}>
            ...
            <div className="pt-2 border-t border-slate-800/80 grid grid-cols-4 gap-2 text-center text-xs">
              <div className="bg-slate-950 p-2 rounded-xl border border-slate-800/80 flex items-center justify-center gap-1.5">
                ...
                <span className="font-extrabold text-blue-400">{correctCount}</span>
          ...
          {calculatorOpen && (
            <div className="fixed bottom-6 right-6 z-50 bg-slate-900 border border-slate-700 p-4 rounded-2xl shadow-2xl w-64 animate-in slide-in-from-bottom-3">
              ...
              <div className="bg-slate-950 p-2 rounded-xl text-right font-mono text-lg text-blue-400 border border-slate-800 mb-3 truncate">
                {calcDisplay}
              </div>
          ...
          {showPalette && (
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 shadow-xl space-y-3 animate-in fade-in">
              <div className="flex items-center justify-between">
                ...
                <button onClick={() => setShowPalette(false)} className="text-slate-400 hover:text-white text-xs flex items-center gap-1 cursor-pointer">
                  <span>Close</span>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-[10px] text-slate-400 pb-2 border-b border-slate-800">
                <span className="flex items-center gap-1"><span className="w-2 h-2 rounded bg-blue-500"></span> Correct</span>
          ...
          {/* Main Question Card */}
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 sm:p-7 shadow-xs space-y-5">
            ...
            <div className="space-y-2.5">
              {(['A', 'B', 'C', 'D'] as const).map((optKey) => {
                ...
                let btnStyle = 'bg-white dark:bg-slate-950 border-slate-200 dark:border-slate-800 text-slate-800 dark:text-slate-200 hover:border-slate-300 dark:hover:border-slate-700';

                if (practiceEngineMode === 'interactive' && selectedAns) {
                  if (optKey === currentQ.correctAnswer) {
                    btnStyle = 'bg-blue-50 dark:bg-blue-950/40 border-blue-500 text-blue-900 dark:text-blue-200 font-bold';
                  } else if (isSelected) {
                    btnStyle = 'bg-rose-50 dark:bg-rose-950/40 border-rose-500 text-rose-900 dark:text-rose-200';
                  }
                } else if (isSelected) {
                  btnStyle = 'bg-blue-50 dark:bg-blue-950/40 border-[#1e3a8a] dark:border-blue-500 text-[#1e3a8a] dark:text-blue-300 font-bold ring-1 ring-[#1e3a8a]';
                }
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left p-3.5 sm:p-4 rounded-xl border text-xs sm:text-sm transition-all flex items-center justify-between cursor-pointer ${btnStyle}`}
                  >
                    <div className="flex items-center space-x-3">
                    ...
                    {isSelected && (
                      <CheckCircle2 className="w-5 h-5 text-[#1e3a8a] dark:text-blue-400 shrink-0" />
                    )}
                  </button>
                );
              })}
            ...
            {/* Interactive SMART Explanation Box */}
            {practiceEngineMode === 'interactive' && selectedAns && (
              <div className="p-4 rounded-xl bg-blue-50/70 dark:bg-slate-950 border border-blue-200 dark:border-blue-500/30 text-xs text-slate-800 dark:text-slate-200 space-y-1.5 animate-in fade-in">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-1.5 font-bold text-[#1e3a8a] dark:text-blue-400">
                    <Sparkles className="w-4 h-4 text-[#1e3a8a] dark:text-blue-400" />
                    <span>SMART Explanation Breakdown</span>
                  </div>
                  {!aiExplanations[currentQ.id] && (
                    <button
                      onClick={handleFetchAiExplanation}
                      disabled={loadingAiExp}
                      className="px-2.5 py-1 bg-white dark:bg-slate-900 border border-blue-300 dark:border-blue-500/30 text-[#1e3a8a] dark:text-blue-300 rounded-md font-semibold text-[11px] hover:bg-blue-50 transition-colors cursor-pointer"
                    >
                      {loadingAiExp ? 'Loading AI Explanation...' : 'Deep AI Breakdown'}
                    </button>
                  )}
                </div>
                <p className="leading-relaxed text-slate-700 dark:text-slate-300">
                  {aiExplanations[currentQ.id] || currentQ.explanation || `The correct answer is Option ${currentQ.correctAnswer}.`}
                </p>
              </div>
            )}
            ...
            <div className="flex items-center justify-between pt-4 border-t border-slate-200 dark:border-slate-800">
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className="px-4 py-2.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 disabled:opacity-40 text-slate-700 dark:text-slate-200 text-xs font-semibold rounded-xl border border-slate-200 dark:border-slate-700 transition-colors flex items-center gap-1.5 cursor-pointer shadow-xs"
                >
                ...
                {practiceEngineMode === 'cbt_simulated' && userAnswers[currentQ.id] && (
                  <button
                    ...
                    className="px-3 py-2.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-950 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 text-xs rounded-xl border border-slate-200 dark:border-slate-800 cursor-pointer shadow-xs"
                  >
                    Clear Answer
                  </button>
                )}
              ...
              {currentIndex < activeQuestions.length - 1 ? (
                <button
                  ...
                  className="px-5 py-2.5 bg-[#1e3a8a] hover:bg-[#172554] text-white text-xs font-bold rounded-xl shadow-xs transition-colors flex items-center gap-1.5 cursor-pointer"
                >
                  Next Question
                ...
                <button
                  ...
                  className="px-6 py-2.5 bg-[#1e3a8a] hover:bg-[#172554] text-white text-xs font-bold rounded-xl shadow-xs transition-colors flex items-center gap-1.5 cursor-pointer"
                >
        ...
        <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 max-w-md w-full shadow-2xl space-y-4 text-center">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button
                onClick={handleFinishPractice}
                className="flex-1 py-3 bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs rounded-xl shadow-lg cursor-pointer"
              >
                View Full Analysis
              </button>
            </div>
