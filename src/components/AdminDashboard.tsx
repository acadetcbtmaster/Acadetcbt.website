...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-6 animate-in fade-in" id="admin-dashboard-container">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-slate-900 border border-slate-800 p-5 rounded-2xl shadow-xl">
        ...
        <div className="flex flex-wrap items-center gap-2.5 self-start md:self-auto">
          ...
          <div className="flex items-center gap-2">
            {syncToastMsg && (
              <span className="hidden sm:inline-flex items-center gap-1 text-[11px] text-blue-400 font-medium bg-blue-500/10 border border-blue-500/30 px-2.5 py-1 rounded-full animate-in fade-in">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 sm:gap-4">
              ...
              >
                <div className="flex justify-between items-start">
                  ...
                  <span className="text-[10px] text-blue-400 font-bold bg-blue-500/10 px-1.5 py-0.5 rounded">↑ 12%</span>
                </div>
                <p className="text-xl font-black text-white mt-1 group-hover:text-indigo-300 transition-colors">{studentsList.length}</p>
                <span className="text-[10px] text-blue-400 font-medium mt-1 block">Registered Users</span>
              </button>
              ...
              <button
                ...
                className="bg-slate-900 hover:bg-slate-800/80 border border-slate-800 hover:border-blue-500/50 p-4 rounded-xl text-left transition-all cursor-pointer group shadow-sm"
              >
                <div className="flex justify-between items-start">
                  <span className="text-[11px] text-slate-400 font-medium">Total Courses</span>
                  <span className="text-[10px] text-blue-400 font-bold bg-blue-500/10 px-1.5 py-0.5 rounded">↑ 15%</span>
                </div>
                <p className="text-xl font-black text-white mt-1 group-hover:text-blue-300 transition-colors">{courses.length}</p>
              ...
              >
                <div className="flex justify-between items-start">
                  ...
                  <span className="text-[10px] text-blue-400 font-bold bg-blue-500/10 px-1.5 py-0.5 rounded">↑ 22%</span>
                </div>
                <p className="text-xl font-black text-white mt-1 group-hover:text-blue-300 transition-colors">{transactions.length}</p>
                <span className="text-[10px] text-blue-400 font-medium mt-1 block">Transactions Logged</span>
              </button>
              ...
              >
                <div className="flex justify-between items-start">
                  ...
                  <span className="text-[10px] text-blue-400 font-bold bg-blue-500/10 px-1.5 py-0.5 rounded">Live</span>
                </div>
                <p className="text-xl font-black text-blue-400 mt-1">{activeStudentsToday}</p>
              ...
              >
                <div className="flex justify-between items-start">
                  ...
                  <span className="text-[10px] text-blue-400 font-bold bg-blue-500/10 px-1.5 py-0.5 rounded">Gross</span>
                </div>
                <p className="text-xl font-black text-blue-400 mt-1">₦{totalRevenue.toLocaleString()}</p>
                <span className="text-[10px] text-blue-500 font-medium mt-1 block">Gross Earnings</span>
              </button>
              ...
              >
                <div className="flex justify-between items-start">
                  ...
                  <span className="text-[10px] text-blue-400 font-bold bg-blue-500/10 px-1.5 py-0.5 rounded">Healthy</span>
                </div>
                <p className="text-sm font-bold text-blue-400 mt-2 flex items-center gap-1.5">
              ...
              >
                <div className="flex justify-between items-start">
                  ...
                  <span className="text-[10px] text-blue-400 font-bold bg-blue-500/10 px-1.5 py-0.5 rounded">Active</span>
                </div>
                <p className="text-sm font-bold text-blue-400 mt-2 flex items-center gap-1.5">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-3">
              ...
              <button
                ...
                className="p-3.5 bg-slate-900 hover:bg-slate-800 border border-slate-800 hover:border-blue-500/50 rounded-xl transition-all text-left flex flex-col justify-between h-24 group cursor-pointer"
              >
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {[
                ...
                { id: 'signup_departments', title: 'Sign-Up Faculties & Departments', desc: 'Manage faculties and departments available during student sign up.', icon: GraduationCap, color: 'text-blue-400', border: 'hover:border-blue-500' },
                ...
                { id: 'courses', title: 'Course Management', desc: 'Manage university-based courses (FUL & FUAHSE).', icon: BookOpen, color: 'text-blue-400', border: 'hover:border-blue-500' },
                ...
                { id: 'payments', title: 'Payment Management', desc: 'View transactions, approve payments & revenue reports.', icon: CreditCard, color: 'text-blue-400', border: 'hover:border-blue-500' },
                ...
                { id: 'activity_logs', title: 'Activity Logs', desc: 'Audit log of all administrative system actions.', icon: History, color: 'text-blue-400', border: 'hover:border-blue-500' },
                ...
                { id: 'system_health', title: 'System Health Diagnostics', desc: 'Server uptime, database status, API sessions & memory.', icon: Server, color: 'text-blue-400', border: 'hover:border-blue-500' },
                ...
                { id: 'security_access', title: 'Security & Access Control', desc: 'Firewall rules, login security, device manager & emergency lock.', icon: ShieldCheck, color: 'text-blue-400', border: 'hover:border-blue-500' },
                  ...
                  >
                    <div>
                      <div className="flex items-center justify-between mb-3">
                        ...
                        {access.hasAccess ? (
                          <span className="px-2 py-0.5 bg-blue-500/10 border border-blue-500/30 text-blue-400 text-[10px] font-bold rounded-full flex items-center gap-1">
                    ...
                    <div className="mt-4 pt-3 border-t border-slate-800/80 flex items-center justify-between text-xs font-semibold text-slate-400 group-hover:text-white">
                      ...
                      <span>{access.hasAccess ? '→' : 'Locked'}</span>
                    </div>
                  </div>
                );
              })}
                        ...
                        <tr key={std.id} className={`hover:bg-slate-800/50 transition-colors ${std.isDeleted ? 'opacity-60 bg-rose-950/10' : ''}`}>
                          ...
                          <td className="p-4">
                            <div>
                              ...
                              >
                                {std.subscription?.isPremium ? <CheckCircle2 className="w-3 h-3 text-blue-400" /> : <XCircle className="w-3 h-3 text-slate-500" />}
                          ...
                          <td className="p-4 text-right space-x-1.5 whitespace-nowrap">
                            ...
                            <button
                              ...
                              className="px-2.5 py-1 bg-blue-600/20 hover:bg-blue-600/30 border border-blue-500/30 text-xs font-bold text-blue-300 rounded-lg cursor-pointer transition-all"
            ...
            <div className="fixed inset-0 z-50 bg-slate-950/85 backdrop-blur-md flex items-center justify-center p-4 overflow-y-auto">
              <div className="bg-slate-900 border border-slate-800 w-full max-w-2xl rounded-2xl p-6 space-y-6 shadow-2xl my-8">
                ...
                <div className="flex flex-wrap items-center gap-2 text-xs">
                  <span className={`px-2.5 py-1 rounded-lg font-bold border ${selectedStudentProfile.subscription?.isPremium ? 'bg-blue-500/10 text-blue-400 border-blue-500/30' : 'bg-slate-800 text-slate-400 border-slate-700'}`}>
                    Sub: {selectedStudentProfile.subscription?.plan || 'Free Trial'}
                  </span>
                  <span className={`px-2.5 py-1 rounded-lg font-bold border ${selectedStudentProfile.isRestricted ? 'bg-amber-500/20 text-amber-300 border-amber-500/40' : 'bg-blue-500/10 text-blue-400 border-blue-500/20'}`}>
                    Access: {selectedStudentProfile.isRestricted ? 'Restricted' : 'Normal'}
                  </span>
                  <span className={`px-2.5 py-1 rounded-lg font-bold border ${selectedStudentProfile.isBanned ? 'bg-rose-500/20 text-rose-300 border-rose-500/40' : 'bg-blue-500/10 text-blue-400 border-blue-500/20'}`}>
                    Standing: {selectedStudentProfile.isBanned ? 'Banned' : 'Active'}
                  </span>
                  <span className={`px-2.5 py-1 rounded-lg font-bold border ${selectedStudentProfile.isDeleted ? 'bg-slate-800 text-slate-400 border-slate-700' : 'bg-blue-500/10 text-blue-400 border-blue-500/20'}`}>
                ...
                <div className="flex flex-wrap gap-1.5 bg-slate-950 p-1.5 rounded-xl border border-slate-800 text-xs font-bold">
                  ...
                  <button
                    ...
                    className={`px-3 py-2 rounded-lg transition-all ${profileModalTab === 'extend' ? 'bg-blue-600 text-white shadow' : 'text-slate-400 hover:text-white'}`}
                  >
                    3. Extend Sub
                  </button>
                  <button
                  ...
                  <div className="space-y-4 text-xs text-slate-300 bg-slate-950 p-5 rounded-2xl border border-slate-800">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <p className="font-bold text-blue-400 text-sm mt-0.5">{selectedStudentProfile.subscription?.questionsAttemptedCount || 12} Tests Completed</p>
                      </div>
                      <div>
            ...
            <div className="fixed inset-0 z-50 bg-slate-950/85 backdrop-blur-md flex items-center justify-center p-4 animate-in fade-in" id="extend-sub-modal">
              <div className="bg-slate-900 border border-indigo-500/40 w-full max-w-lg rounded-3xl p-6 sm:p-7 space-y-5 shadow-2xl relative">
                <div className="flex justify-between items-center pb-3 border-b border-slate-800">
                  ...
                  <button onClick={() => setExtendSubStudent(null)} className="p-1.5 text-slate-400 hover:text-white bg-slate-800 rounded-xl cursor-pointer">
                    <X className="w-4 h-4" />
                  </button>
                </div>
                  ...
                  <div>
                    ...
                    <p className="text-xs font-bold text-white mt-0.5">
                      {extendSubStudent.subscription?.isPremium ? (
                        <span className="text-blue-400">Active ({extendSubStudent.subscription.plan})</span>
                      ) : (
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 bg-slate-800 hover:bg-slate-700 text-xs font-bold text-blue-300 rounded-lg border border-slate-700"
                    >
                      +1 Month
                    </button>
                    <button
                ...
                <div className="bg-blue-950/40 border border-blue-500/30 p-3.5 rounded-2xl flex items-center justify-between">
                  <div>
                    <span className="text-[10px] uppercase font-bold text-blue-400 block">New Expiration Date</span>
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <button
                    type="button"
                    onClick={handleApplySubscriptionExtension}
                    className="flex-1 py-3 bg-blue-600 hover:bg-blue-500 text-white font-extrabold text-xs rounded-xl shadow-lg shadow-blue-600/30 transition-all cursor-pointer flex items-center justify-center gap-2"
                  >
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
            ...
            >
              ...
              <span className="text-[10px] text-blue-400 font-semibold mt-1 block">Enabled</span>
            </button>
          ...
          <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl space-y-4 shadow-xl">
            ...
            <form onSubmit={handleAddUniversitySubmit} className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              <button
                type="submit"
                className="py-2.5 bg-blue-600 hover:bg-blue-500 text-white font-extrabold text-xs rounded-xl transition-all cursor-pointer shadow-lg shadow-blue-600/20"
              >
            ...
            <div className="fixed inset-0 z-50 bg-slate-950/85 backdrop-blur-md flex items-center justify-center p-4">
              <div className="bg-slate-900 border border-slate-800 w-full max-w-lg rounded-2xl p-6 space-y-5 shadow-2xl">
                <div className="flex justify-between items-start pb-3 border-b border-slate-800">
                  ...
                  <button onClick={() => setSelectedUniversityDetail(null)} className="p-1.5 text-slate-400 hover:text-white bg-slate-800 rounded-xl cursor-pointer">
                    <X className="w-4 h-4" />
                  </button>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3 text-xs">
                  ...
                  <div className="p-3 bg-slate-950 rounded-xl border border-slate-800">
                    ...
                    <p className="text-sm font-bold text-blue-400 mt-0.5">Active Partner</p>
                  </div>
                </div>
                ...
                <div className="space-y-2 pt-2">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    ...
                    <button
                      ...
                      className="p-2.5 bg-blue-600/20 hover:bg-blue-600/30 border border-blue-500/30 text-blue-300 text-xs font-bold rounded-xl text-center cursor-pointer"
                    >
                      View Students
                    </button>
                    <button
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2.5 pt-2 border-t border-slate-800/80">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl px-2.5 py-2 text-xs text-blue-300 font-semibold focus:outline-none focus:border-blue-500 cursor-pointer"
                >
            ...
            <div className="fixed inset-0 z-50 bg-slate-950/85 backdrop-blur-md flex items-center justify-center p-4">
              <div className="bg-slate-900 border border-slate-800 w-full max-w-lg rounded-2xl p-6 space-y-5 shadow-2xl">
                <div className="flex justify-between items-start pb-3 border-b border-slate-800">
                  ...
                  <button onClick={() => setSelectedCourseDetail(null)} className="p-1.5 text-slate-400 hover:text-white bg-slate-800 rounded-xl cursor-pointer">
                    <X className="w-4 h-4" />
                  </button>
                </div>
            ...
            <div className="fixed inset-0 z-50 bg-slate-950/85 backdrop-blur-md flex items-center justify-center p-4 overflow-y-auto">
              <div className="bg-slate-900 border border-slate-800 w-full max-w-xl rounded-3xl p-6 sm:p-7 space-y-5 shadow-2xl my-6">
                <div className="flex justify-between items-center pb-3 border-b border-slate-800">
                  ...
                  <button onClick={() => setNewCourseModalOpen(false)} className="text-slate-400 hover:text-white p-1 rounded-lg bg-slate-800 cursor-pointer">
                    <X className="w-4 h-4" />
                  </button>
                </div>
                ...
                <form onSubmit={handleAddCourseSubmit} className="space-y-4">
                  ...
                  <div className="p-3 bg-slate-950 border border-indigo-500/30 rounded-xl">
                    ...
                    <p className="text-xs font-medium text-slate-200 flex flex-wrap items-center gap-1">
                      ...
                      <span className="text-slate-600">›</span>
                      <span className="text-blue-300 font-semibold">{getDepartmentsForFaculty(newCourseFacultyId, newCourseUniId, departments, faculties).find(d => d.id === newCourseDeptId)?.name || 'Department'}</span>
                      <span className="text-slate-600">›</span>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full bg-slate-950 border border-slate-800 p-2.5 rounded-xl text-xs text-blue-300 font-semibold focus:outline-none focus:border-blue-500 cursor-pointer"
                        required
                      >
                  ...
                  <div className="flex gap-3 pt-2">
                    ...
                    <button
                      type="submit"
                      className="flex-1 py-3 bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs rounded-xl shadow-lg shadow-blue-600/20 cursor-pointer"
                    >
            ...
            <div className="fixed inset-0 z-50 bg-slate-950/85 backdrop-blur-md flex items-center justify-center p-4 overflow-y-auto">
              <div className="bg-slate-900 border border-slate-800 w-full max-w-xl rounded-3xl p-6 sm:p-7 space-y-5 shadow-2xl my-6">
                <div className="flex justify-between items-center pb-3 border-b border-slate-800">
                  ...
                  <button onClick={() => setEditingCourse(null)} className="text-slate-400 hover:text-white p-1 rounded-lg bg-slate-800 cursor-pointer">
                    <X className="w-4 h-4" />
                  </button>
                </div>
              ...
              >
                ...
                {genUploadedFile ? (
                  <div className="flex flex-col items-center gap-3">
                    {genImagePreview ? (
                      <div className="relative w-32 h-32 rounded-xl overflow-hidden border border-blue-500/40 shadow-lg">
                    ...
                    <div>
                      <span className="px-2.5 py-1 bg-blue-500/10 border border-blue-500/30 text-blue-400 text-xs font-bold rounded-full inline-block mb-1">
            ...
            <div className="divide-y divide-slate-800">
              {generatorHistory.map((h) => (
                <div key={h.id} className="py-3 flex justify-between items-center text-xs">
                  ...
                  <span className="px-2.5 py-0.5 bg-blue-500/10 text-blue-400 text-[10px] font-bold rounded-full border border-blue-500/30">
                    {h.status}
                  </span>
                </div>
              ))}
                      ...
                      {(Object.keys(DEFAULT_ROLE_PERMISSIONS) as RbacAdminRole[]).map((r) => {
                        ...
                        return (
                          <td key={r} className={`p-3 text-center ${r === currentRole ? 'bg-amber-500/5' : ''}`}>
                            {isGranted ? (
                              <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-blue-500/20 text-blue-400 font-bold text-xs">
                                <Check className="w-3 h-3" />
                              </span>
                            ) : (
