    ...
    switch (type) {
      ...
      case 'CBT Updates':
        return {
          ...
          badge: 'bg-indigo-600 text-white font-extrabold shadow-xs',
          icon: Megaphone,
      ...
      case 'Emergency':
        return {
          ...
          badge: 'bg-amber-600 text-white font-extrabold shadow-xs',
          icon: Wrench,
      ...
      case 'Payment':
        return {
          ...
          badge: 'bg-blue-600 text-white font-extrabold shadow-xs',
          icon: CheckCircle2,
      ...
      default:
        return {
          ...
          badge: 'bg-slate-700 text-white font-extrabold shadow-xs',
          icon: Bell,
          iconColor: 'text-indigo-400',
        };
    }
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className={`px-2.5 py-0.5 text-xs font-black rounded-full uppercase tracking-wider ${style.badge}`}>
                  {currentNotif.type}
                </span>
                {currentNotif.priority === 'Urgent' || currentNotif.priority === 'High' ? (
                  <span className="px-2.5 py-0.5 text-xs font-black rounded-full bg-rose-600 text-white uppercase animate-pulse shadow-xs">
                    Urgent
                  </span>
                ) : null}
              </div>
