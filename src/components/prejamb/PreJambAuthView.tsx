  ...
  return (
    <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4 sm:p-6 lg:p-8 font-sans">
      <div className="w-full max-w-4xl bg-white rounded-3xl shadow-2xl overflow-hidden grid grid-cols-1 md:grid-cols-2 border border-slate-200/80 min-h-[580px]">
        ...
        {/* ================= LEFT DEEP BLUE BRAND PANEL ================= */}
        <div className="bg-gradient-to-b from-blue-950 via-blue-900 to-slate-950 p-8 sm:p-12 text-white flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="space-y-8 relative z-10">
            ...
            <div className="w-32 h-32 relative">
              <svg viewBox="0 0 200 200" className="w-full h-full drop-shadow-md">
                <circle cx="100" cy="100" r="92" fill="#1e3a8a" stroke="#1d4ed8" strokeWidth="4" />
                <circle cx="100" cy="100" r="82" fill="#172554" stroke="#2563eb" strokeWidth="1.5" strokeDasharray="3 3" />
                <defs>
                ...
                <circle cx="100" cy="100" r="62" fill="#0f172a" stroke="#60a5fa" strokeWidth="2" />
                <path d="M 75 75 Q 100 68 125 75 Q 125 110 100 128 Q 75 110 75 75 Z" fill="#1e40af" stroke="#93c5fd" strokeWidth="1.5" />
                <path d="M 85 85 Q 92 80 105 82 Q 115 88 112 100 Q 108 112 100 115 Q 90 110 86 100 Z" fill="#1d4ed8" opacity="0.9" />
                ...
                <text x="100" y="122" fill="#bfdbfe" fontSize="8.5" fontWeight="bold" textAnchor="middle" letterSpacing="1">JAMB</text>
              </svg>
              <div className="absolute -bottom-2 w-full flex flex-col items-center">
                <div className="bg-blue-950 text-white border border-blue-400 px-3 py-0.5 rounded-md shadow-md text-[10px] font-black tracking-wider">
                  CBT TEST
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3.5 pt-2">
              <div className="flex items-center gap-3 text-sm text-blue-100 font-medium">
                <div className="w-5 h-5 rounded-full bg-blue-500/20 border border-blue-400/50 flex items-center justify-center text-blue-300 shrink-0">
          ...
          {/* Footer Contact */}
          <div className="pt-8 border-t border-blue-800/60 flex items-center gap-2 text-xs text-blue-300/80">
          ...
          <div className="max-w-md w-full mx-auto space-y-6">
            ...
            <form onSubmit={handleFormSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 bg-white border border-slate-300 rounded-xl text-xs text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600 transition-all placeholder:text-slate-400"
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 pr-10 bg-white border border-slate-300 rounded-xl text-xs text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600 transition-all placeholder:text-slate-400"
                    required
                  />
                  <button
                    type="button"
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-3 px-4 bg-blue-950 hover:bg-blue-900 text-white font-bold text-xs rounded-xl shadow-lg shadow-blue-950/20 hover:shadow-blue-950/30 transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
              >
                {isLoading ? (
