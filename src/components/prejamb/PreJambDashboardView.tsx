...
export const PreJambDashboardView: React.FC<PreJambDashboardViewProps> = ({
  ...
  useEffect(() => {
    ...
    refreshData();
    window.addEventListener('prejamb_database_updated', refreshData);
    window.addEventListener('cbt_storage_change', refreshData);

    return () => {
      window.removeEventListener('prejamb_database_updated', refreshData);
      window.removeEventListener('cbt_storage_change', refreshData);
    };
  }, [user]);
  ...
  return (
    <div className="min-h-screen w-full max-w-full bg-slate-50 flex flex-col font-sans text-slate-800">
      ...
      <header className="bg-white border-b border-slate-200 px-6 py-3.5 flex items-center justify-between sticky top-0 z-30 shadow-2xs">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-blue-950 text-white flex items-center justify-center font-black text-xs shadow-xs">
            PJ
          </div>
          <div>
            <span className="text-xs sm:text-sm font-extrabold tracking-wider text-blue-950 uppercase block leading-tight">
              ACADET CBT MASTER
            </span>
            <span className="text-[10px] text-blue-700 font-bold uppercase tracking-wider block leading-tight mt-0.5">
              Pre-JAMB Academy CBT • {dbStats.totalQuestions} Questions Available
            </span>
          </div>
        </div>
          ...
          <div className="pt-4 border-t border-slate-100 space-y-3">
            <div className="p-3 bg-slate-50 rounded-xl border border-slate-200/80 text-[11px] space-y-1">
              <div className="flex items-center justify-between font-bold text-slate-700">
                ...
                <span className="text-blue-700 font-extrabold">Online</span>
              </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-5 py-2.5 bg-blue-950 hover:bg-blue-900 text-white font-bold text-xs rounded-xl shadow-xs transition-all flex items-center gap-1.5 cursor-pointer"
              >
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div
                ...
                className="p-5 bg-white border border-slate-200 hover:border-blue-500/80 rounded-2xl shadow-xs hover:shadow-md transition-all cursor-pointer group flex flex-col justify-between space-y-3"
              >
                <div className="space-y-2">
                  <div className="w-9 h-9 rounded-xl bg-blue-50 text-blue-800 flex items-center justify-center group-hover:scale-105 transition-transform">
                    <BookOpen className="w-5 h-5" />
                  </div>
                  <div>
                    <h3 className="text-sm font-black text-slate-900 group-hover:text-blue-800 transition-colors">
                      Practice by Subject
                    </h3>
                ...
                <div className="flex items-center text-xs font-bold text-blue-700 group-hover:text-blue-800">
