                ...
                <div className="space-y-3 pt-1">
                  ...
                  {(['A', 'B', 'C', 'D'] as const).map((optKey, idx) => {
                    ...
                    if (isCorrectAnswer) {
                      ...
                      marker = <span className="text-emerald-700 font-bold text-xs ml-auto flex items-center gap-1"><CheckCircle2 className="w-3.5 h-3.5" /> Correct</span>;
                    } else if (isUserPick && !isCorrectAnswer) {
                      optStyle = 'border-rose-400 bg-rose-50/70 text-rose-950 font-bold';
                      marker = <span className="text-rose-700 font-bold text-xs ml-auto flex items-center gap-1"><XCircle className="w-3.5 h-3.5" /> Your choice</span>;
                    }
