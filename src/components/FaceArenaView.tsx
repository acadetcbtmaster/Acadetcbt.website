...
export const FaceArenaView: React.FC<FaceArenaViewProps> = ({ user, onNavigate }) => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 py-6 space-y-6" id="face-arena-view-container">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-10 text-center space-y-6 shadow-2xl relative overflow-hidden" id="face-arena-ready-screen">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 max-w-md mx-auto text-left text-xs bg-slate-950/60 p-4 rounded-2xl border border-slate-800">
            ...
            <div>
              ...
              <span className="font-extrabold text-blue-400 text-sm">{settings.passingScorePercentage || 50}%</span>
            </div>
          </div>
          ...
          <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            {(!settings.testMode || settings.testMode === 'in_app' || settings.testMode === 'both') && (
              <button
                ...
                className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-400 hover:to-indigo-500 text-white font-black text-sm rounded-2xl shadow-xl shadow-blue-500/20 transition-all flex items-center justify-center gap-2 cursor-pointer"
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6" id="face-arena-result-screen">
          ...
          <div className="text-center space-y-3">
            <div className={`w-16 h-16 rounded-3xl flex items-center justify-center mx-auto text-white shadow-xl ${
              currentParticipant.passed ? 'bg-blue-500 shadow-blue-500/30' : 'bg-amber-500 shadow-amber-500/30'
            }`}>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <div className="p-4 bg-slate-950/60 rounded-2xl border border-slate-800 text-center">
              ...
              <span className="text-xs font-bold text-blue-300">{currentParticipant.percentage}%</span>
            </div>
                    ...
                    return (
                      ...
                      >
                        <td className="px-4 py-3.5">
                          {rank === 1 ? (
                            <span className="px-2.5 py-1 bg-amber-500 text-slate-950 font-bold rounded-lg text-[10px] flex items-center gap-1 w-fit shadow-xs">
                              1st
                            </span>
                          ) : rank === 2 ? (
                            <span className="px-2.5 py-1 bg-slate-300 text-slate-950 font-bold rounded-lg text-[10px] flex items-center gap-1 w-fit">
                              2nd
                            </span>
                          ) : rank === 3 ? (
                            <span className="px-2.5 py-1 bg-amber-700 text-amber-100 font-bold rounded-lg text-[10px] flex items-center gap-1 w-fit">
                              3rd
                            </span>
                          ) : (
                        ...
                        <td className="px-4 py-3.5 font-extrabold text-blue-400">
