...
export const FaceArenaAdminModule: React.FC = () => {
  ...
  return (
    <div className="space-y-6" id="face-arena-admin-module">
      ...
      {/* Top Banner Notice */}
      {notificationMsg && (
        <div className="p-4 bg-blue-500/20 border border-blue-500/40 rounded-2xl text-blue-300 text-xs font-bold flex items-center justify-between shadow-lg animate-fade-in">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              <div className="p-4 bg-slate-950/60 rounded-2xl border border-slate-800">
                ...
                <span className={`text-base font-extrabold uppercase mt-1 block ${
                  settings.status === 'open' ? 'text-blue-400' : 'text-rose-400'
                }`}>
                  {settings.status}
                </span>
              </div>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center text-xs p-3 bg-slate-950/60 rounded-xl border border-slate-800">
                ...
                <span className="font-extrabold text-blue-400">{completedParticipants.length}</span>
              </div>
              <div className="flex justify-between items-center text-xs p-3 bg-slate-950/60 rounded-xl border border-slate-800">
                ...
                <div key={q.id} className="p-4 bg-slate-950/60 rounded-2xl border border-slate-800 flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div className="space-y-1.5 max-w-2xl">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-black px-2 py-0.5 bg-blue-500/20 text-blue-300 rounded border border-blue-500/30">
        ...
        <div className="fixed inset-0 z-50 bg-slate-950/85 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 max-w-2xl w-full max-h-[90vh] flex flex-col shadow-2xl space-y-4">
            ...
            {!isSmartPreviewStep ? (
              ...
              /* PREVIEW STEP */
              <div className="space-y-4 text-xs overflow-y-auto pr-1 flex-1">
                <div className="p-3 bg-blue-500/10 border border-blue-500/30 rounded-xl text-blue-300 flex items-center justify-between">
                ...
                <div className="pt-2 flex justify-end gap-2 border-t border-slate-800">
                  ...
                  <button
                    ...
                    className="px-6 py-2 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl shadow-lg flex items-center gap-1.5 cursor-pointer"
                  >
              ...
              <tbody className="divide-y divide-slate-800 bg-slate-900/60">
                {filteredParticipants.map((p) => (
                  <tr key={p.id} className="hover:bg-slate-800/40">
                    ...
                    <td className="px-4 py-3 font-bold text-blue-400">{p.score} / {p.totalQuestions}</td>
                    ...
                    <td className="px-4 py-3">
                      <span className={`px-2 py-0.5 rounded text-[10px] font-bold ${
                        p.status === 'completed'
                          ? p.passed ? 'bg-blue-500/20 text-blue-300' : 'bg-rose-500/20 text-rose-300'
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            ...
            <div className="p-5 bg-slate-950/60 rounded-2xl border border-slate-800 text-center">
              ...
              <p className="text-3xl font-black text-blue-400 mt-1">{completionRate}%</p>
            </div>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="p-5 bg-blue-500/10 border border-blue-500/30 rounded-2xl text-center">
              <span className="text-xs font-bold text-blue-300 uppercase block">Passed Challenge</span>
              <p className="text-2xl font-black text-blue-400 mt-1">{numberPassed}</p>
            </div>
