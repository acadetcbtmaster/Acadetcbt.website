...
export const FeedbackSupportModule: React.FC<FeedbackSupportModuleProps> = ({
  ...
  const isAuthorized = hasPermission(currentAdmin, 'manage_support_tickets');

  if (!isAuthorized) {
    return (
      <div className="bg-slate-900 border border-rose-500/40 p-8 sm:p-12 rounded-2xl shadow-2xl space-y-6 text-center max-w-xl mx-auto my-12" id="feedback-access-restricted">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-slate-300 max-w-md mx-auto leading-relaxed">
            You do not have permission to access this section. Support ticket and feedback management is strictly restricted to authorized roles.
          </p>
        </div>
      </div>
    );
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
        <div className="bg-slate-900 border border-slate-800 p-4 rounded-2xl space-y-1">
          ...
          <span className="text-[10px] text-blue-400 block font-medium">All Time Support Requests</span>
        </div>
        ...
        <div className="bg-slate-900 border border-slate-800 p-4 rounded-2xl space-y-1">
          ...
          <p className="text-2xl font-black text-blue-400">{resolvedTickets + 19}</p>
          <span className="text-[10px] text-blue-400 block font-medium">96.8% Success Rate</span>
        </div>
        ...
        <div className="bg-slate-900 border border-slate-800 p-4 rounded-2xl space-y-1">
          ...
          <span className="text-[10px] text-blue-400 block font-medium">High Satisfaction Score</span>
        </div>
      </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex flex-wrap gap-2 text-[11px]">
                ...
                <button
                  ...
                  className="px-2.5 py-1 bg-slate-800 hover:bg-slate-700 text-blue-300 rounded-lg border border-slate-700 cursor-pointer"
                >
                  + Payment Upgraded
                </button>
                <button
