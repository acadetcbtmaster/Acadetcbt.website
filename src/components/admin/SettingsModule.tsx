...
export const SettingsModule: React.FC<SettingsModuleProps> = ({
  ...
  const isAuthorized = hasPermission(currentAdmin, 'manage_settings');

  if (!isAuthorized) {
    return (
      <div className="bg-slate-900 border border-rose-500/40 p-8 sm:p-12 rounded-2xl shadow-2xl space-y-6 text-center max-w-xl mx-auto my-12" id="settings-access-restricted">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-slate-300 max-w-md mx-auto leading-relaxed">
            You do not have permission to access this section. System configuration and settings management is strictly restricted to authorized roles.
          </p>
        </div>
      </div>
    );
    ...
    <div className="space-y-6">
      ...
      <div className="bg-slate-900/90 backdrop-blur-md border border-slate-800 p-6 rounded-3xl shadow-xl flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          <button
            ...
            disabled={isSaving}
            className="px-5 py-2.5 bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs rounded-2xl cursor-pointer shadow-lg shadow-blue-600/20 transition-all flex items-center gap-2"
          >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3.5">
        <div onClick={() => setActiveTab('general')} className="bg-slate-900 border border-slate-800 p-4 rounded-2xl cursor-pointer hover:border-indigo-500/50 transition-all space-y-1">
          ...
          <p className="text-xl font-black text-white">v3.8.2 <span className="text-[10px] font-bold text-blue-400">PROD</span></p>
        ...
        <div onClick={() => setActiveTab('health')} className="bg-slate-900 border border-slate-800 p-4 rounded-2xl cursor-pointer hover:border-indigo-500/50 transition-all space-y-1">
          ...
          <p className="text-xl font-black text-blue-400 flex items-center gap-1">
        ...
        <div onClick={() => setActiveTab('maintenance')} className="bg-slate-900 border border-slate-800 p-4 rounded-2xl cursor-pointer hover:border-indigo-500/50 transition-all space-y-1">
          ...
          <p className={`text-xl font-black ${settings.maintenance.enabled ? 'text-rose-400' : 'text-blue-400'}`}>
        ...
        <div onClick={() => setActiveTab('firebase')} className="bg-slate-900 border border-slate-800 p-4 rounded-2xl cursor-pointer hover:border-indigo-500/50 transition-all space-y-1">
          ...
          <p className="text-xl font-black text-blue-400">Supabase OK</p>
        ...
        <div onClick={() => setActiveTab('auth')} className="bg-slate-900 border border-slate-800 p-4 rounded-2xl cursor-pointer hover:border-indigo-500/50 transition-all space-y-1">
          ...
          <p className="text-[9px] text-blue-400">OAuth Active</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 p-4 bg-slate-950/60 rounded-2xl border border-slate-800">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-950 border border-slate-800 rounded-xl p-2.5 text-blue-300 font-bold focus:outline-none focus:border-blue-500"
              />
          ...
          <div className="divide-y divide-slate-800 text-xs">
            {settings.integrations.map((item) => (
              <div key={item.id} className="py-3 flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                  <span className="px-2.5 py-0.5 bg-blue-500/10 text-blue-400 rounded-full font-bold text-[10px]">
                    {item.status}
                  </span>
                  <button
