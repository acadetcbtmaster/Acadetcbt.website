    ...
    <div className="space-y-6" id="leaderboard-admin-module">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4" id="summary-cards-grid">
        ...
        <div
          ...
          className="bg-slate-900 border border-slate-800 hover:border-blue-500/50 p-4 rounded-2xl transition-all cursor-pointer shadow-lg group relative overflow-hidden"
        >
          <div className="flex items-center justify-between text-slate-400 mb-2">
            <span className="text-[11px] font-bold uppercase tracking-wider">Top Weekly</span>
            <Crown className="w-4 h-4 text-blue-400 group-hover:scale-110 transition-transform" />
          </div>
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="p-4 text-center">
                            <span className="text-sm font-extrabold text-blue-400">{student.averageScore}%</span>
                          ...
                          <td className="p-4 text-center">
                            <div className="w-20 mx-auto bg-slate-950 rounded-full h-2 overflow-hidden border border-slate-800">
                              <div
                                className="bg-gradient-to-r from-amber-500 to-blue-400 h-full rounded-full"
              ...
              <div className="space-y-3 pt-2">
                <div>
                  <div className="flex justify-between text-xs font-bold text-slate-300 mb-1">
                    ...
                    <span className="text-blue-400">42% of students</span>
                  </div>
            ...
            <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl space-y-4 shadow-xl">
              ...
              <div className="divide-y divide-slate-800 text-xs">
                <div className="py-3 flex items-center justify-between">
                  ...
                  <span className="px-2.5 py-1 bg-blue-500/10 text-blue-400 border border-blue-500/20 font-bold rounded-lg">
                    88.4% Mean Score
                  </span>
                </div>
          ...
          <div className="bg-slate-900 border border-slate-800 w-full max-w-2xl rounded-3xl p-6 space-y-6 shadow-2xl relative overflow-hidden">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 bg-slate-950 p-4 rounded-2xl border border-slate-800">
              ...
              <div className="text-center">
                ...
                <span className="text-xl font-black text-blue-400">{selectedStudent.averageScore}%</span>
              </div>
              <div className="text-center">
