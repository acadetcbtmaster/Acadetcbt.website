  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 gap-3">
        ...
        <div className="bg-slate-900 border border-slate-800/80 p-4 rounded-2xl">
          <span className="text-[10px] font-bold text-blue-400 uppercase tracking-wider block">Lecture Notes</span>
          <p className="text-xl font-black text-blue-400 mt-1">{summary.notes}</p>
        </div>
            ...
            <div className="space-y-3 text-xs text-slate-300">
              ...
              <div className="grid grid-cols-2 gap-2 text-[11px]">
                ...
                <div className="p-2 bg-slate-950 rounded-lg">
                  ...
                  <span className="font-bold text-blue-400">{viewingMaterial.totalDownloads}</span>
                </div>
              </div>
