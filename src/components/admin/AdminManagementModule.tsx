    ...
    <div className="space-y-6" id="admin-management-module-root">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3 sm:gap-4">
        ...
        >
          ...
          <p className="text-2xl font-black text-blue-400 mt-1">{onlineAdmins}</p>
          <span className="text-[10px] text-blue-400/80 font-medium mt-1 block">Active Live Sessions</span>
        </button>
        ...
        <div className="bg-slate-900 border border-slate-800 p-4 rounded-xl text-left shadow-sm">
          ...
          <p className="text-2xl font-black text-blue-400 mt-1">{loginsToday}</p>
            ...
            <div className="bg-indigo-950/80 border border-indigo-500/30 p-3 rounded-xl flex items-center justify-between text-xs animate-in fade-in">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-3 py-1.5 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-lg cursor-pointer flex items-center gap-1"
                >
                      ...
                      <tr key={admin.id} className="hover:bg-slate-800/40 transition-colors">
                        ...
                        <td className="p-4">
                          <div className="flex items-center gap-3">
                            <div className="relative">
                              ...
                              <span className={`absolute bottom-0 right-0 w-2.5 h-2.5 rounded-full border-2 border-slate-900 ${admin.isOnline ? 'bg-blue-400' : 'bg-slate-500'}`} />
                            </div>
                        ...
                        <td className="p-4">
                          <span className={`px-2 py-0.5 rounded-md text-[10px] font-bold flex items-center gap-1 w-fit ${
                            ...
                            <span className={`w-1.5 h-1.5 rounded-full ${admin.status === 'Active' ? 'bg-blue-400' : 'bg-rose-400'}`} />
                            {admin.status}
                          </span>
                        </td>
                            ...
                            <button
                              ...
                              className={`p-1.5 rounded-lg transition-colors cursor-pointer ${
                                admin.status === 'Active'
                                  ...
                                  : 'bg-slate-800 hover:bg-blue-600/30 text-blue-400'
                              }`}
              ...
              {sessions.map(sess => (
                <div key={sess.sessionId} className="bg-slate-950 border border-slate-800 p-4 rounded-xl space-y-3 relative">
                  <div className="flex items-start justify-between">
                    ...
                    <span className="px-2 py-0.5 bg-blue-500/10 text-blue-400 text-[10px] font-bold rounded flex items-center gap-1">
              ...
              {securityAlerts.map(alert => (
                <div key={alert.id} className="bg-slate-950 border border-rose-500/30 p-4 rounded-xl flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  ...
                  <button
                    ...
                    className="px-3.5 py-1.5 bg-slate-800 hover:bg-blue-600 text-slate-200 hover:text-white rounded-lg text-xs font-bold transition-all shrink-0 cursor-pointer"
                  >
                    Mark Resolved
                  </button>
                </div>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-lg p-6 space-y-5 shadow-2xl relative">
            ...
            <div className="bg-slate-950 border border-slate-800 p-4 rounded-xl space-y-2 text-xs text-slate-300">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-semibold text-blue-400">{viewProfileAdmin.status}</span>
              </div>
              <div className="flex justify-between">
