...
export const ReportsManagementModule: React.FC<ReportsManagementModuleProps> = ({
  ...
  const isAuthorized = hasPermission(currentAdmin, 'manage_reports');

  if (!isAuthorized) {
    return (
      <div className="bg-slate-900 border border-rose-500/40 p-8 sm:p-12 rounded-2xl shadow-2xl space-y-6 text-center max-w-xl mx-auto my-12" id="reports-access-restricted">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-slate-300 max-w-md mx-auto leading-relaxed">
            You do not have permission to access this section. Reports and analytics management is strictly restricted to authorized roles.
          </p>
        </div>
      </div>
    );
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-10 gap-3">
        ...
        >
          ...
          <span className="text-[9px] text-blue-400 block mt-0.5">Database Live</span>
        </div>
        ...
        <div
          ...
          className="bg-slate-900 hover:bg-slate-800/80 border border-slate-800 p-3.5 rounded-2xl cursor-pointer transition-all group"
        >
          <p className="text-[10px] font-bold uppercase text-slate-400 group-hover:text-blue-400 transition-colors">Revenue Reports</p>
          <p className="text-xl font-black text-blue-400 mt-1">{revenueReportsCount}</p>
          <span className="text-[9px] text-blue-400 block mt-0.5">Paystack Audits</span>
        </div>
        ...
        <div
          ...
          className="bg-slate-900 hover:bg-slate-800/80 border border-slate-800 p-3.5 rounded-2xl cursor-pointer transition-all group"
        >
          <p className="text-[10px] font-bold uppercase text-slate-400 group-hover:text-blue-400 transition-colors">Course Reports</p>
          <p className="text-xl font-black text-blue-400 mt-1">{courseReportsCount}</p>
          <span className="text-[9px] text-blue-300 block mt-0.5">Subject Analytics</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
          ...
          <div className="bg-slate-950 border border-slate-800 p-4 rounded-xl space-y-3">
            <div className="flex justify-between items-center">
              ...
              <span className="text-[10px] font-bold text-blue-400 bg-blue-500/10 px-2 py-0.5 rounded">+34.2%</span>
            </div>
      ...
      <div className="bg-gradient-to-r from-slate-900 via-indigo-950/40 to-slate-900 border border-indigo-800/60 p-5 rounded-2xl space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs">
          <div className="bg-slate-950/80 border border-slate-800 p-3.5 rounded-xl space-y-1">
            <span className="font-bold text-blue-400 block">High Engagement Course: GST101</span>
            ...
            <div className="flex justify-between items-center pt-3 border-t border-slate-800">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs rounded-xl flex items-center gap-1.5 shadow-lg cursor-pointer"
                >
