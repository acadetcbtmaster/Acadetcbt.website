        ...
        <div className="space-y-6">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <div className="bg-slate-900 border border-slate-800 p-5 rounded-2xl">
              ...
              <span className="text-[10px] text-blue-400 font-bold mt-1 block">Live AI Logged</span>
            </div>
            <div className="bg-slate-900 border border-slate-800 p-5 rounded-2xl">
            ...
            <div className="bg-slate-900 border border-slate-800 p-5 rounded-2xl">
              ...
              <span className="text-[10px] text-blue-400 font-bold mt-1 block">Student Feedback</span>
            </div>
            <div className="bg-slate-900 border border-slate-800 p-5 rounded-2xl">
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            ...
            <div className="bg-slate-900 border border-slate-800 p-5 rounded-2xl">
              ...
              <p className="text-2xl font-black text-blue-400 mt-1">~120 ms</p>
            </div>
            <div className="bg-slate-900 border border-slate-800 p-5 rounded-2xl">
              ...
              <div className="space-y-2 text-xs">
                {[
                  ...
                  <div key={idx} className="flex justify-between items-center bg-slate-950 p-3 rounded-xl border border-slate-800">
                    ...
                    <span className="text-blue-400 font-extrabold">{nav.clicks} clicks</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              {[
                ...
                ['sky', 'Sky Blue Vibrant', 'bg-sky-600'],
                ['violet', 'Violet Sleek', 'bg-violet-600'],
                ['amber', 'Amber Warm', 'bg-amber-600'],
                ['blue', 'Royal Blue Classic', 'bg-blue-600'],
            ...
            <div className="bg-slate-950 p-5 rounded-2xl border border-slate-800 space-y-3">
              <div className="flex items-center justify-between">
                ...
                {testResult.unanswered && (
                  <span className="text-xs font-bold text-amber-400">Notice: No direct KB match logged</span>
                )}
              </div>
              ...
              {testResult.navigationTarget && (
                <div className="pt-2">
                  <span className="px-3 py-1 bg-blue-500/10 border border-blue-500/30 text-blue-400 font-bold text-xs rounded-xl inline-block">
