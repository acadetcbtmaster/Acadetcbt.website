    ...
    <div className="space-y-6" id="security-access-module-root">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 sm:gap-4">
        ...
        <div className="bg-slate-900 border border-slate-800 p-4 rounded-xl text-left shadow-sm">
          ...
          <p className="text-2xl font-black text-blue-400 mt-1">Protected</p>
          <span className="text-[10px] text-blue-400/80 font-medium mt-1 block">App Check Validated</span>
        </div>
        ...
        <div className="bg-slate-900 border border-slate-800 p-4 rounded-xl text-left shadow-sm">
          ...
          <span className="text-[10px] text-blue-400 font-medium mt-1 block">Past 24 Hours</span>
        </div>
        ...
        >
          ...
          <p className="text-2xl font-black text-blue-400 mt-1">178 Active</p>
          <span className="text-[10px] text-blue-400/80 font-medium mt-1 block">CBT Mobile & Desktop</span>
        </div>
        ...
        <div className="bg-slate-900 border border-slate-800 p-4 rounded-xl text-left shadow-sm">
          ...
          <p className="text-2xl font-black text-blue-400 mt-1">LOW</p>
          <span className="text-[10px] text-blue-400/80 font-medium mt-1 block">Zero Active Exploits</span>
        </div>

        {/* Firewall Status */}
        <div
          onClick={() => setActiveTab('ip_management')}
          className="bg-slate-900 border border-slate-800 p-4 rounded-xl text-left shadow-sm hover:border-blue-500/50 cursor-pointer transition-all"
        >
          <div className="flex justify-between items-start">
            <span className="text-[11px] text-slate-400 font-medium">Firewall Status</span>
            <Globe className="w-4 h-4 text-blue-400" />
          </div>
          <p className="text-2xl font-black text-blue-400 mt-1">Filtering</p>
          <span className="text-[10px] text-blue-400/80 font-medium mt-1 block">{blockedIps.length} Blocked IPs</span>
        </div>
                ...
                {activeSessions
                  ...
                  .map(ses => (
                    <tr key={ses.id} className="hover:bg-slate-950/50 transition-colors">
                      ...
                      <td className="p-3 font-bold text-blue-400">{ses.lastActivity}</td>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-5">
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            ...
            <button
              ...
              className="px-3.5 py-1.5 bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs rounded-xl cursor-pointer"
            >
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <span className={`px-2 py-0.5 rounded text-[10px] font-bold ${
                        dev.trustStatus === 'Trusted' ? 'bg-blue-500/20 text-blue-300' : 'bg-rose-500/20 text-rose-300'
                      }`}>
                        {dev.trustStatus}
                      </span>
                    </div>
      ...
      {activeTab === 'insights' && (
        <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl space-y-6">
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            ...
            <span className="px-3.5 py-1 bg-blue-500/10 text-blue-300 border border-blue-500/30 text-xs font-black rounded-full">
