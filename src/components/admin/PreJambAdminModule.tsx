        ...
        >
          <div className="flex items-start md:items-center gap-2.5">
            {connTestResult.needsSchemaInit ? (
              ...
              <CheckCircle2 className="w-5 h-5 text-blue-400 shrink-0 mt-0.5 md:mt-0" />
            ) : (
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
            ...
            <div className="bg-slate-900 border border-slate-800 p-4 rounded-xl">
              ...
              <p className="text-2xl font-black text-blue-400 mt-1">{stats.totalExams}</p>
            ...
            <div className="bg-slate-900 border border-slate-800 p-4 rounded-xl">
              ...
              <p className="text-2xl font-black text-blue-400 mt-1">{stats.highestAggregate}/400</p>
            ...
            <div className="lg:col-span-2 bg-slate-900 border border-slate-800 p-5 rounded-2xl space-y-4">
              ...
              <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/80 space-y-3 text-xs text-slate-300">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="font-bold text-blue-300">Centralized Admin Control:</span> You have single-pane-of-glass administrative governance to add questions, adjust mock exam durations, and activate/deactivate tests in real time.
                  </div>
                </div>
              </div>
                  ...
                  {filteredQuestions.length === 0 ? (
                    ...
                    filteredQuestions.map((q, idx) => (
                      <tr key={q.id} className="hover:bg-slate-800/40 transition-colors">
                        ...
                        <td className="p-3.5">
                          <span className="px-2 py-1 bg-blue-500/10 text-blue-400 border border-blue-500/30 rounded-lg font-bold font-mono">
            ...
            {subjects.map((subj) => (
              <div key={subj.id} className="bg-slate-900 border border-slate-800 p-4 rounded-2xl space-y-3">
                <div className="flex items-start justify-between">
                  ...
                  <span
                    className={`px-2 py-0.5 text-[10px] font-bold rounded-full border ${
                      subj.isActive ? 'bg-blue-500/10 text-blue-400 border-blue-500/30' : 'bg-slate-800 text-slate-500 border-slate-700'
                    }`}
                  >
            ...
            {exams.map((exam) => (
              <div key={exam.id} className="bg-slate-900 border border-slate-800 p-5 rounded-2xl space-y-4">
                <div className="flex items-start justify-between">
                  ...
                  <span
                    className={`px-2 py-0.5 text-[10px] font-bold rounded-full border ${
                      exam.isActive ? 'bg-blue-500/10 text-blue-400 border-blue-500/30' : 'bg-slate-800 text-slate-500 border-slate-700'
                    }`}
                  >
                  ...
                  {filteredCandidates.length === 0 ? (
                    ...
                    filteredCandidates.map((c) => (
                      <tr key={c.id} className="hover:bg-slate-800/40 transition-colors">
                        ...
                        <td className="p-3.5">
                          <span className="font-bold text-blue-400">{c.bestScore || 0}%</span>
                        </td>
                        <td className="p-3.5">
                          <span
                            className={`px-2 py-0.5 text-[10px] font-bold rounded-full border ${
                  ...
                  {filteredResults.length === 0 ? (
                    ...
                    filteredResults.map((r) => (
                      <tr key={r.id} className="hover:bg-slate-800/40 transition-colors">
                        ...
                        <td className="p-3.5">
                          <span className="px-2 py-0.5 bg-blue-500/10 text-blue-400 border border-blue-500/30 rounded-lg font-black font-mono">
      ...
      {activeTab === 'settings' && (
        <div className="space-y-6">
          <form onSubmit={handleSaveSettings} className="bg-slate-900 border border-slate-800 p-6 rounded-2xl space-y-6">
            ...
            {settingsSavedToast && (
              <div className="p-3 rounded-xl bg-blue-950/40 border border-blue-500/50 text-blue-300 text-xs flex items-center gap-2">
              ...
              {selectedQuestionForPreview.options.map((opt, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isCorrect && <Check className="w-4 h-4 text-blue-400" />}
                  </div>
                );
              })}
            </div>
            ...
            <div className="p-5 space-y-4 overflow-y-auto text-xs text-slate-300 scrollbar-thin">
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 p-3 bg-indigo-950/40 border border-indigo-500/30 rounded-xl">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    {copiedSql ? <Check className="w-4 h-4 text-blue-300" /> : <Copy className="w-4 h-4" />}
              ...
              <div className="relative">
                <pre className="p-4 bg-slate-950 border border-slate-800 rounded-xl text-[11px] font-mono text-blue-400 max-h-60 overflow-y-auto leading-relaxed whitespace-pre scrollbar-thin">
