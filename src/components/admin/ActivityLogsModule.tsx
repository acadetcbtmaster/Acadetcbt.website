    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        <div className="bg-slate-900 border border-slate-800/80 p-5 rounded-3xl space-y-2 hover:border-slate-700 transition-all">
          ...
          <p className="text-[10px] text-blue-400 font-medium">Real-time Supabase Database synced</p>
        </div>
        ...
        <div className="bg-slate-900 border border-slate-800/80 p-5 rounded-3xl space-y-2 hover:border-slate-700 transition-all">
          ...
          <p className="text-[10px] text-blue-400 font-medium">Successful user auth sessions</p>
        </div>
