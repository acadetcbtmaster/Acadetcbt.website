    ...
    <div className="space-y-6" id="system-health-module-root">
      ...
      {toastMessage && (
        <div className={`fixed top-4 right-4 z-50 px-5 py-3 rounded-xl shadow-2xl flex items-center gap-3 border text-xs font-bold transition-all animate-in fade-in slide-in-from-top-3 ${
          ...
          {toastMessage.type === 'error' ? <AlertOctagon className="w-5 h-5 text-rose-400" /> : <CheckCircle2 className="w-5 h-5 text-blue-400" />}
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="px-2.5 py-0.5 bg-blue-500/20 text-blue-300 text-[10px] font-bold rounded-full border border-blue-500/30 flex items-center gap-1">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 sm:gap-4">
        ...
        <div className="bg-slate-900 border border-slate-800 p-4 rounded-xl text-left shadow-sm">
          ...
          <p className="text-2xl font-black text-blue-400 mt-1">99.8%</p>
          <span className="text-[10px] text-blue-400/80 font-medium mt-1 block">Optimal Operational</span>
        </div>
        ...
        <div className="bg-slate-900 border border-slate-800 p-4 rounded-xl text-left shadow-sm">
          ...
          <span className="text-[10px] text-blue-400 font-medium mt-1 block">Authentication & SDK</span>
        </div>
        ...
        <div className="bg-slate-900 border border-slate-800 p-4 rounded-xl text-left shadow-sm">
          ...
          <p className="text-2xl font-black text-blue-400 mt-1">Operational</p>
          <span className="text-[10px] text-blue-400/80 font-medium mt-1 block">SSL Validated</span>
        </div>
        ...
        <div className="bg-slate-900 border border-slate-800 p-4 rounded-xl text-left shadow-sm">
          ...
          <p className="text-2xl font-black text-blue-400 mt-1">{activeConnections}</p>
          <span className="text-[10px] text-blue-400/80 font-medium mt-1 block">Connected Users</span>
        </div>
        ...
        <div className="bg-slate-900 border border-slate-800 p-4 rounded-xl text-left shadow-sm">
          ...
          <span className="text-[10px] text-blue-400/80 font-medium mt-1 block">30-Day SLA</span>
        </div>
        ...
        <div className="bg-slate-900 border border-slate-800 p-4 rounded-xl text-left shadow-sm">
          ...
          <span className="text-[10px] text-blue-400 font-medium mt-1 block">Well Below Limit</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-slate-900 border border-slate-800 p-5 rounded-2xl space-y-3">
            <div className="flex justify-between items-center">
              ...
              <span className="text-xs font-mono font-black text-blue-400">{memoryUsage}%</span>
            </div>
      ...
      {(activeTab === 'database' || activeTab === 'firebase') && (
        <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl space-y-6">
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            ...
            >
              <RefreshCw className={`w-3.5 h-3.5 text-blue-400 ${isCheckingSupabase ? 'animate-spin' : ''}`} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 space-y-1">
              ...
              <p className="text-[10px] text-blue-400/80">Active for all catalog queries</p>
            </div>
            ...
            <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 space-y-1">
              ...
              <p className="text-[10px] text-blue-400">All schemas synchronized</p>
            </div>
          </div>
              ...
              {[
                ...
                <div key={table.name} className="bg-slate-950 border border-slate-800/80 p-3.5 rounded-xl flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <span className="px-2 py-0.5 bg-blue-500/10 text-blue-400 font-mono font-bold text-[10px] rounded-md border border-blue-500/20">
                      Active ({table.count})
                    </span>
                  </div>
                </div>
        ...
        <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
            <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 text-center">
              ...
              <p className="text-2xl font-black text-blue-400 mt-1">98/100</p>
            </div>
            <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 text-center">
            ...
            <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 text-center">
              ...
              <p className="text-2xl font-black text-blue-400 mt-1">94/100</p>
            </div>
          </div>
                ...
                <div key={err.id} className="bg-slate-950 border border-slate-800 p-4 rounded-xl flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs">
                  ...
                  {err.status === 'Active' ? (
                    <button
                      ...
                      className="px-3.5 py-1.5 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl cursor-pointer shrink-0"
                    >
                      Mark Resolved
                    </button>
                  ) : (
                    <span className="px-3 py-1 bg-blue-500/10 text-blue-400 font-bold rounded-lg text-[10px]">
                      Resolved
                    </span>
                  )}
                </div>
      ...
      {activeTab === 'logs' && (
        <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl space-y-4 text-xs">
          <div className="flex items-center justify-between pb-3 border-b border-slate-800">
            ...
            <span className="font-mono text-blue-400 font-bold">{systemLogs.length} Events Logged</span>
          </div>
