    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-10 gap-3">
        ...
        >
          ...
          <span className="text-[9px] text-blue-400 block mt-0.5">Live Synchronized</span>
        </div>
        ...
        <div
          ...
          className="bg-slate-900 hover:bg-slate-800/80 border border-slate-800 p-3.5 rounded-2xl cursor-pointer transition-all group"
        >
          <p className="text-[10px] font-bold uppercase text-slate-400 group-hover:text-blue-400 transition-colors">Delivered</p>
          <p className="text-xl font-black text-blue-400 mt-1">{deliveredCount}</p>
          <span className="text-[9px] text-blue-400 block mt-0.5">FCM Confirmed</span>
        </div>
      ...
      <div className="bg-slate-900 border border-slate-800 p-4 rounded-2xl flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="px-3 py-1.5 bg-slate-800 hover:bg-blue-600/30 text-blue-300 border border-slate-700 text-[11px] font-bold rounded-lg cursor-pointer transition-all"
          >
            + Payment Alert
          </button>
          <button
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="bg-slate-950 p-4 rounded-xl border border-slate-800">
              ...
              <span className="text-[10px] text-blue-400 mt-1 block">Active Mobile & Web Tokens</span>
            </div>
          </div>
                ...
                {notifications.slice(0, 4).map((n) => (
                  <div key={n.id} className="flex justify-between items-center text-xs border-b border-slate-800/80 pb-2">
                    ...
                    <div className="text-right">
                      <span className="font-bold text-blue-400 text-xs">{n.totalRead} Opened</span>
                    ...
                    filteredNotifications.map((notif) => (
                      <tr key={notif.id} className="hover:bg-slate-800/40 transition-colors">
                        ...
                        <td className="p-4 font-mono">
                          ...
                          <p className="text-[10px] text-blue-400">{notif.totalRead} Read</p>
                        </td>
            ...
            <div className="space-y-3 text-xs text-slate-300">
              ...
              <div className="grid grid-cols-2 gap-3 bg-slate-950 p-3 rounded-xl border border-slate-800 text-[11px]">
                ...
                <div>
                  ...
                  <p className="font-bold text-blue-400 mt-0.5">{viewingNotification.totalRecipients.toLocaleString()}</p>
                </div>
                <div>
