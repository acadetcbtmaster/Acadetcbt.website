    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3.5">
        ...
        >
          ...
          <p className="text-[9px] text-blue-400 truncate">{lastRestore ? lastRestore.backupName : 'System stable'}</p>
        </div>
        ...
        >
          ...
          <p className="text-xl font-black text-blue-400">{backupHealthScore}%</p>
          <p className="text-[9px] text-blue-400/80">Optimal Status</p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 bg-slate-900 border border-slate-800 rounded-3xl p-6 space-y-4">
              <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                ...
                <span className="px-2.5 py-1 bg-blue-500/10 text-blue-400 rounded-full text-[10px] font-bold border border-blue-500/20">
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 space-y-4">
              ...
              <div className="space-y-3 text-xs">
                <div className="flex items-center justify-between p-3 bg-slate-950 rounded-2xl border border-slate-800">
                  ...
                  <span className={`font-bold ${autoConfig.enabled ? 'text-blue-400' : 'text-rose-400'}`}>
                ...
                <div key={b.id} className="py-3 flex flex-wrap items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className={`px-2.5 py-0.5 rounded-full text-[10px] font-bold ${
                      b.verificationStatus === 'Verified' ? 'bg-blue-500/10 text-blue-400' : 'bg-amber-500/10 text-amber-400'
                    }`}>
                      {b.verificationStatus}
                    </span>
                    <button
                      onClick={() => setRestoreTarget(b)}
                      className="px-2.5 py-1 bg-blue-600/20 hover:bg-blue-600 text-blue-300 hover:text-white border border-blue-500/30 font-bold text-[10px] rounded-xl cursor-pointer transition-all"
                    >
                      Restore
                    </button>
                  </div>
                      ...
                      <tr key={b.id} className="hover:bg-slate-850/50 transition-colors">
                        ...
                        <td className="py-3.5 px-4 text-right">
                          <div className="flex items-center justify-end gap-1">
                            ...
                            <button
                              onClick={() => setRestoreTarget(b)}
                              className="px-2.5 py-1.5 bg-blue-600 hover:bg-blue-500 text-white font-bold text-[10px] rounded-xl cursor-pointer"
                            >
                              Restore
                            </button>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3 text-xs">
              <div className="bg-slate-950 p-4 rounded-2xl border border-slate-800 space-y-1">
                ...
                <p className="text-2xl font-black text-blue-400">100.0%</p>
              </div>
