    ...
    <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-md flex items-center justify-center p-3 sm:p-4 animate-in fade-in overflow-y-auto">
      ...
      >
        ...
        <div>
          ...
          >
            {is80 
              ? (isGuest ? '80% Guest Limit Reached' : '80% Free Trial Limit Warning')
        ...
        <div className="pt-2 flex flex-col gap-2.5 shrink-0">
          {isGuest && onOpenSignUp ? (
            <button
              ...
              className="w-full py-3.5 bg-gradient-to-r from-indigo-600 via-indigo-500 to-blue-600 hover:from-indigo-500 hover:to-blue-500 text-white font-black text-xs sm:text-sm rounded-xl shadow-xl transition-all flex items-center justify-center gap-2 cursor-pointer active:scale-[0.98]"
